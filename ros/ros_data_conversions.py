...
def rosvoxel_to_octomap(vox: ROSVoxelGrid) -> OctomapWithPose:
    ...
    owp.origin.position.x    = 0.0
    owp.origin.position.y    = 0.0
    owp.origin.position.z    = 0.0
    # **must** set a valid quaternion!
    owp.origin.orientation.x = 0.0
    owp.origin.orientation.y = 0.0
    owp.origin.orientation.z = 0.0
    owp.origin.orientation.w = 1.0
